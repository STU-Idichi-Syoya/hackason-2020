...
ss_msg = "";
  ...
  ss_msg = "\u30B0\u30ED\u30FC\u30D0\u30EB\u30B5\u30A4\u30F3\u8A8D\u8A3C\u30B5\u30A4\u30C8　SSL secured \u30AF\u30EA\u30C3\u30AF\u3057\u3066\u78BA\u8A8D　GlobalSign byGMO";
...
function ss_open_sub(){
  ...
  ss_url_p1          = "08a572f8"
  ss_url_p2          = "f43b7e70f16f9a49cd683e54a888256c184067b4a7652821a971c519d2377b48c88e392a435f3dabb6786016f06f9b4dd0337e08f7"
  ss_url_p3          = "122a7dc457d55cee1a6a62c31cc5d098286109bf"
  ss_profileLocation = "https://" + ss_profile_domain + "/SiteSeal/siteSeal/profile/profile.do?p1=" + ss_url_p1 + "&p2=" + ss_url_p2 + "&p3=" + ss_url_p3;
  window.open(
    ss_profileLocation,
    'ss_wnd',
    'status=1,location=1,scrollbars=1,resizable=0,width=600,height=825'
  );
}
...
function writeFlash() {
  ...
  var str =
    ...
    "<PARAM NAME='flashVars' VALUE='timeText=15:50:36(JST)'>" +
    "<PARAM NAME='wmode' VALUE='transparent'>" +    
    "<EMBED src='" + ss_flashLocation + "' FlashVars='timeText=15:50:36(JST)'" +
    " WIDTH='" + ss_width + "'" +
    " HEIGHT='" + ss_height + "'" +
    " NAME='ss_imgTag'" +
